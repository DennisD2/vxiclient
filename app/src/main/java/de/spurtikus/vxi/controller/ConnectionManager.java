...
public class ConnectionManager {
     ...
     *
     * @param deviceClass
     * @param mfName      mainframe name
     * @param deviceName  device name
     * @throws Exception
     */
    protected static void initialize(Class<? extends AbstractController<?>> deviceClass, String mfName, String deviceName)
            throws Exception {
     ...
     * @return usable key
     */
    private static String key(Class<? extends AbstractController<?>> deviceClass,
     ...
     *
     * @param deviceClass
     * @param mfName      mainframe name (as defined in property file
     *                    vxiserver.properties).
     * @return
     * @throws Exception
     */
    public static ConnectionManager getInstance(Class<? extends AbstractController<?>> deviceClass, String mfName, String deviceName)
            throws Exception {
        if (INSTANCE == null) {
    ...
    public VXIConnector getConnector(Class<? extends AbstractController<?>> deviceClass, String mainframe,
                                     String devname) {
        return connections.get(key(deviceClass, mainframe, devname))
                .getVxiConnector();
    }

    public DeviceLink getLink(Class<? extends AbstractController<?>> deviceClass,
                              String mainframe, String devname) {
        return connections.get(key(deviceClass, mainframe, devname))
                .getLinkId();
    }

    public BaseHPDevice getDevice(Class<? extends AbstractController<?>> deviceClass,
                                  String mainframe, String devname) {
        return connections.get(key(deviceClass, mainframe, devname))
                .getDevice();
    }
