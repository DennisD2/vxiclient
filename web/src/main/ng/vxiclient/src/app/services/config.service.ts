...
export class ConfigService {
  ...
  private baseUrl: string; // = 'http://localhost:8888/vxi/api/rest/';
  private servicePostfix = 'api/rest/';
  ...
  public getURL( mainframe: string,  name: string ) {
    ...
    console.log('Got URL for name: ' + name + ': ' + this.getServiceUrl() + l[0].URL );
    return this.getServiceUrl() + l[0].URL;
  }

  public setBaseUrl( url: string ) {
    console.log('Application base URL: ' + this.baseUrl );
    this.baseUrl = url;
  }
  ...
  public getServiceUrl() {
    return this.baseUrl + this.servicePostfix;
  }
  public fake() {
